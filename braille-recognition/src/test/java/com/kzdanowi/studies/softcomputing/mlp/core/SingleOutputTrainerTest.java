...
public class SingleOutputTrainerTest {

	private Trainer trainer;
	private GenericMultiLayerNetwork network;
	...
	@Before
	public void setUp() {
		network = Mockito.mock(GenericMultiLayerNetwork.class);
		trainer = new SingleOutputTrainer(network);
